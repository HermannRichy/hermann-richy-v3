...
export const projects: Project[] = [
    ...
    },
    {
        id: "scrap-pro",
        title: "Scrap-Pro",
        desc: "Scrape un catalogue e-commerce entier, le traduit avec DeepL, réécrit le SEO et l'exporte prêt à l'import WooCommerce.",
        tags: [
            { label: "Python", bg: "bg-brand", color: "text-white" },
            { label: "Flask", bg: "bg-dark", color: "text-lime" },
            yearTag(2026),
        ],
        image: "/projects/scrap-pro.png",
        url: "https://scrap-pro.onrender.com",
        photoBg: "bg-purple",
        featured: true,
    },
    {
