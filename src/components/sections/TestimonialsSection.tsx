...
const testimonials = [
    ...
    {
        quote: "Notre site inspire enfin la confiance qu'on donne à nos clients tous les jours. Pro, clair, et qui charge vite.",
        name: "Enock Dekenou",
        role: "PDG, Well Steven",
        bg: "bg-dark",
        color: "text-white",
        avatarBg: "bg-brand",
    ...
    {
        quote: "Notre centre a gagné en crédibilité en ligne, et les inscriptions arrivent directement depuis le site.",
        name: "Serge Houndode",
        role: "PDG, Cefora Formation",
        bg: "bg-lime",
        color: "text-dark",
        avatarBg: "bg-dark",
        shadow: "shadow-brutal",
    ...
    {
        quote: "Code propre, architecture pensée pour durer. Rare de voir autant de rigueur associée à autant de rapidité d'exécution.",
        name: "Igor Adande",
