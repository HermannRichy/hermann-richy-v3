...
export default function ProjectsSection() {
    ...
    useGSAP(
        () => {
            // Calcul direct de la distance sans variables de sécurité intermédiaires
            const getDist = () =>
            ...
            gsap.to(trackRef.current, {
                ...
                ease: "none",
                scrollTrigger: {
                    trigger: sectionRef.current, // Déclencheur sur le parent principal
                    start: "top top",
                    end: () => "+=" + getDist(),
                    scrub: true, // Version simplifiée de scrub: 1
                    pin: true, // Épingle la section complète
                    invalidateOnRefresh: true, // Recalcule au redimensionnement d'écran
                },
            });
        },
        { scope: sectionRef },
